...
# --- SERVER SETTINGS ---
# We now have three separate endpoints to call
...
class App(ctk.CTk):
    def __init__(self):
        ...
        self.grid_rowconfigure(0, weight=1)  # The TabView will expand
        ...
        self.tab_view.add("Home")  # Tab 1
        self.tab_view.add("Search")  # Tab 2
        ...
        self.search_tab.grid_rowconfigure(2, weight=1)  # Search results
    ...
    # --- GENERIC FUNCTION TO CREATE A FILE WIDGET ---
    ...
    def check_server_and_load_home(self):
        """Checks if the server is running, then loads home data."""
    ...
    def load_home_page_data(self):
        """Starts the threads to fetch recent and popular files."""
    ...
    def _fetch_home_lists(self):
        """Fetches data from the server's new endpoints."""
        ...
        try:
            ...
            # Pass both lists back to the main thread for UI update
    ...
    def display_home_lists(self, recent_files, popular_files):
        """Populates the Home tab with file widgets."""
        # Clear old widgets
    ...
    def run_search(self, query):
        ...
        try:
            ...
            if response.status_code == 200:
                ...
                self.after(0, self.display_error, error_msg, is_search=True)
        except requests.exceptions.ConnectionError:
            self.after(0, self.display_error,
    ...
    def display_search_results(self, results):
        """Displays the search results in the search tab."""
        for widget in self.search_results_frame.winfo_children():
            widget.destroy()
